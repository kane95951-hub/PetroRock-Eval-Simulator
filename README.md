...
Le laboratoire numérique propose les modes **Guidé**, **Examen** et **Défi**. Sa coupe 2D animée montre le four, l’échantillon, une ligne de gaz schématique et les signaux S1/S2/S3. La rampe suit 250, 300, 400, 450 et 600 °C; les pics, le repère Tmax, l’état de chauffe et la température sont synchronisés avec le cycle. Les cas de défi masquent les indices avant la réponse. Une bibliothèque rappelle les paramètres principaux et leurs unités. Un guide de démarrage en une minute accompagne les nouvelles visites et reste accessible dans l’en-tête.
...
styles.v2.0.5.css  thèmes, mise en page responsive, impression et guide
script.v2.0.5.js   génération des signaux, indices, QC, import/export, graphiques et guide
